Class_13_Mini_Project
================
HungHsiu.Lin

General step:

read coldata and countdata -filter 0 count genes
...
``` r
countData_nozero <- rowSums(counts)>0

head(countData_nozero)
```
...
``` r
counts = counts[countData_nozero, ]
head(counts)
```
...
LFC \> 0 (up) : 4349, 27% LFC \< 0 (down) : 4393, 27%
...
![](Mini_-Project_files/figure-gfm/unnamed-chunk-14-1.png)
...
![](Mini_-Project_files/figure-gfm/unnamed-chunk-15-1.png)
...
```
    ...
    Info: Working in directory C:/UCSD/Fall 2022/BIMM143/bimm143/Class13Mini_Project
...
Endosomal/Vacuolar pathway; It does not match with the previous KEGG
results. The factor and calculation account for the two methods are
different.
